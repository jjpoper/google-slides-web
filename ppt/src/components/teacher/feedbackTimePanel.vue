<template>
  <div class="page">
    ...
    <div class="item">
      <div :class="mode == 2 ? 'text' : 'text text--disable'">Deadline</div>
      <el-date-picker
        v-model="deadline"
    ...
    <div class="item">
      <div :class="mode == 3 ? 'text' : 'text text--disable'">Term of validity</div>
      <el-select v-model="value" placeholder="Select a time" :disabled="mode != 3">
        <el-option v-for="item in times" :key="item.value" :label="item.label" :value="item.value"></el-option>
      </el-select>
    </div>

    <div class="item center">
      <div class="btn_class" @click="confirm(mode,deadline,value)">Detemine</div>
    </div>
  </div>
</template>
