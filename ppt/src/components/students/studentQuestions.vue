  ...
  <div>
    <div class="mark-area" @click="markup($event)">
      ...
      <el-popover
        ...
        <div slot="reference" class="markitem markpos" :style="`top:${currentPosition.top}px;left:${currentPosition.left}px`">buttons</div>
      </el-popover>
    </div>
    <el-dialog
...
export default {
  ...
  methods: {
    markup(e) {
      ...
      this.currentPosition = {left, top, content_width: offsetWidth, content_height: offsetHeight}
