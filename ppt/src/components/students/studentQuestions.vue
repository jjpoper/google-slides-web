<template>
  <div>
    <div class="mark-area" @click="markup($event)" @mousemove="move($event)">
      ...
      <!-- <div 
        :style="`width:${nextPosition.pageX - currentPosition.pageX}px;
        height:${nextPosition.pageY - currentPosition.pageY}px;
        position: absolute;
        left: ${currentPosition.pageX}px;
        top: ${currentPosition.pageY}px;
...
export default {
  ...
  data() {
    return {
      ModalEventsTypeEnum,
      currentPosition: { left: 0, top: 0, content_width: 0, content_height: 0, pageX: 0, pageY: 0 },
      nextPosition: {pageX: 0, pageY: 0},
