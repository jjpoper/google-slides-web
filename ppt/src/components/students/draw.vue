    ...
    <div class="canvasfooter">
      ...
      <el-tooltip content="mark up" placement="top">
        <div class="eraser" @click="drawMark">
          ...
          :fill="`${currentTab == 5 ? color : 'rgb(212 208 208)'}`" p-id="5490"></path></svg>
        </div>
      </el-tooltip>
